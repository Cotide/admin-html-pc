...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            { 
                var itemLength= $(box).find("a[class='l-link']").length;
                var header = $('<div class="l-accordion-header"><div class="l-accordion-header-inner"></div></div>');
                if(itemLength> 0)
                {
                    header = $('<div class="l-accordion-header"><div class="l-accordion-toggle"></div><div class="l-accordion-header-inner"></div></div>');
                } 
                if (i == selectedIndex)
                    $(".l-accordion-toggle", header).addClass("l-accordion-toggle-open");
                if ($(box).attr("title"))
                {
                    var mainItemIcon =  $(box).attr("icon"); 
                    var mainItemUrl =  $(box).attr("url"); 
                    var mainItemTxt = $(box).attr("title");
                    var mainItemTabId =  $(box).attr("tabid");
   
                    if(mainItemUrl !="undefined")
                    {
                        mainItemTxt = "<a   style=\"color: #090d90;\" href=\"javascript:f_addTab('tab_"+mainItemTabId+"','"+mainItemTxt+"','"+mainItemUrl+"',true)\"  > "+ mainItemTxt+"</a>"
                    }  
                    if(mainItemIcon !="undefined" )
                    { 
                        $(".l-accordion-header-inner", header).html("<i class=\""+mainItemIcon+"\" style=\"font-size: 15px;\" ></i> "+mainItemTxt); 
                    }else{
                        $(".l-accordion-header-inner", header).html(mainItemTxt); 
                    }
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            if ($("> div[position=left]", g.layout).length > 0)
            {
                ...
                g.left.header = $('<div class="l-layout-header"><div class="l-layout-header-toggle"></div><div style="font-size: 14px;" class="l-layout-header-inner"></div></div>');
                ...
                if (lefttitle)
                {
                    ...
                    var menuicon =  g.left.content.attr("icon");
                    if(menuicon!=undefined)
                    {
                        lefttitle = "<i class=\""+menuicon+"\"></i> "+lefttitle 
                    }
            ...
            if ($("> div[position=right]", g.layout).length > 0)
            {
                ...
                g.right.header = $('<div class="l-layout-header"><div class="l-layout-header-toggle"></div><div style="font-size: 14px;"  class="l-layout-header-inner"></div></div>');
                ...
                if (righttitle)
                {
                    ...
                    if(menuicon!=undefined)
                    {
                        righttitle = "<i class=\""+menuicon+"\"></i> "+righttitle 
                    }
        ...
        { 
            ...
            if (g.center)
            {
                ...
                g.center.css({ left: g.centerLeft -2 });
                g.center.width(g.centerWidth);
...
(function ($)
{
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        setTabButton: function ()
        {
            ...
            {
                g.tab.links.append('<div class="l-tab-links-left"><i class="icon-arrow-left" style="font-size:14px;"></i></div><div class="l-tab-links-right"><i class="icon-arrow-right" style="font-size:14px;"></i></div>');
                g.setTabButtonEven();
                return true;
            } else
            {
